...
#define BLE_UUID_BATTERY_UUID											0xBA00 // UUID for the battery characteristic
#define BLE_UUID_NOTES_UUID 											0xBB00 // UUID for the notes characteristic
...
typedef struct
{
    ...
    // OUR_JOB: Step 2.D, Add handles for the characteristic attributes to our struct
		 ...
		 ble_gatts_char_handles_t    notes_char_handles;
}ble_os_t;
